...
namespace Dapper.Contrib.BulkInsert.Test
{
    public class ClickHouseADOUnitTest
    {
        ...
        {
            conn.Execute(
                "CREATE TABLE IF NOT EXISTS TestUser (ResisterDate Date, ResisterTime DateTime64(3) DEFAULT now64(3), Name String, Age Int32) ENGINE=MergeTree(ResisterDate,(ResisterTime,Name,Age), 8192)");
